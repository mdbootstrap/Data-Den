  ...
  return (
    <>
      ...
      <div style={{ margin: "10px", display: "flex", gap: "5px" }}>
        <button onClick={() => dataDen.current?.sort("car", "asc")}>
          Sort asc by car
        </button>
        <button onClick={() => dataDen.current?.sort("car", "desc")}>
          Sort desc by car
        </button>
        <button onClick={() => dataDen.current?.sort("price", "asc")}>
          Sort asc by price
        </button>
        <button onClick={() => dataDen.current?.sort("price", "desc")}>
          Sort desc by price
        </button>
      </div>
    </>
