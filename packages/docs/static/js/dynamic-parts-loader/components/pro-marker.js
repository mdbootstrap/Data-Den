...
export const proComponentMarkerId = DPL.defineComponent({
  ...
  template: (userData) => {
    if (userData.isProSubscription) {
      return `<a data-te-ripple-init class="text-danger" href="https://mdbootstrap.com/profile/my-orders/" role="button">
